// Sincroniza JUNHO com filtros CORRETOS
...
(async () => {
  ...
  for (const p of periodos) {
    ...
    if (p.tipo === 'omnichannel') {
      // Omnichannel: filtrado por data de VENDA + flag is_omnichannel
      ...
      // Site e Cortesia: filtrado por data de UTILIZAÇÃO
  ...
  console.log('✅ JUNHO SINCRONIZADO COM FILTROS CORRETOS!\n');
